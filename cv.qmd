...
subtitle: "Senior Data Scientist | Causal Inference, Experimentation & Product Analytics"
format:
  html:
    toc: true
...
- **GitHub:** [github.com/krystiankorzec](https://github.com/krystiankorzec)
...
Proven track record of translating complex statistical logic into actionable product strategy and measurable business outcomes.

---

## Key Competencies & Tech Stack

- **Causal Inference & Experimentation:** Heterogeneous Treatment Effect (CATE) estimation, Double Machine Learning, A/B Testing, Synthetic Controls, Online Experimental Design, Uplift Modeling.
...
- Designed the online A/B experimentation strategy for the Best Price Guarantee program, enabling precise causal evaluation and optimization of pricing interventions across high-volume marketplace offers, processing millions of daily offer updates.
...
- Engineered production MLOps pipelines on GCP (BigQuery, Airflow) with automated model monitoring, bridging complex statistical logic with high-availability systems.
...
- Designed and deployed orchestration logic using open-source Dagster to govern data pipelines, integrating automated freshness monitoring rules and failure notifications.
- Upgraded and maintained a live Flask API serving risk scoring models, implementing new features and endpoints to support downstream application requirements.
- **Tech Stack:** Python, AWS, GitHub, Dagster, SQL
